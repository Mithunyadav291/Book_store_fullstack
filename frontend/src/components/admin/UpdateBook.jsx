...
const UpdateBook = () => {
      ...
      setLoading(true)
       try {
        ...
        {toast.error("Please fill all the fields")}
          ...
          const response=await axios.put(`http://localhost:3000/api/book/updateBook/${id}`,bookData, {withCredentials:true})
  ...
  return (
    <div className='h-[100%] p-2 sm:p-4 bg-zinc-900'>
       
         <h1 className='text-zinc-300 mb-4 text-3xl font-semibold'>Update Book</h1>
